        ...
        <div class="col-md-6 col-md-offset-3">
          <form class="form-horizontal" role="form" autocomplete="off" action="NuevaRecetaServlet">
            <div class="form-group">
              <label for="inombreMedico" class="col-sm-2 control-label">Médico</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="nombreMedico" id="nombreMedico" placeholder="Nombre">
              </div>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="numColegiado" id="numColegiado" placeholder="Núm. Colegiado">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="posologia" class="col-sm-2 control-label">Posología</label>
              <div class="col-sm-10">
