...
<html lang="es">
 ...
 Inicio </a></li>
            ...
            <li class="active"><a href="nomenclator.jsp"><span class="glyphicon glyphicon-star"> </span> Nomenclátor</a></li>
          </ul>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1 text-center">
          ...
          <object type="text/html" data="http://www.msssi.gob.es/profesionales/nomenclator.do" width="100%" height="600px"> </object>
    ...
    <div id="footer" class="container">
      <nav class="navbar navbar-default navbar-fixed-bottom">
          <div class="navbar-inner navbar-content-center col-md-8 col-md-offset-2">
              <p class="text-muted text-center credit center">Ingeniería de Tecnologías y Servicios de Telecomunicación (ISST) - Curso 2013/14 - <a href="#myModal" data-toggle="modal" data-target="#myModal"> CrÃ©ditos</a></p>
          </div>
          <div class="col-md-2">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body text-center">
              ...
              <p>
              Para la asignatura <acronym title="IngenierÃ­a de TecnologÃ­as y Servicios de TelecomunicaciÃ³n">ISST</acronym> (4º curso, especialidad Telemática) del Grado en Ingeniería de Tecnologías y Servicios de Telecomunicación de la ETSI de Telecomunicación (UPM)
              </p>
